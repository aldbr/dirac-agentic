"""Multi-agent example with manager and specialized sub-agents.

Demonstrates:
- Custom tools (calculate_cargo_travel_time with haversine formula)
- Manager/worker agent hierarchy
- Output validation with multimodal model (gpt-4o)
