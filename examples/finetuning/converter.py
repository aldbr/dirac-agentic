"""Document conversion utilities for finetuning data preparation.

Converts RST, Markdown, and PDF documents to plain text for use in
QA dataset generation pipelines.
